 ...
 */
export declare function toConfirmResponse<T extends 'confirm' | 'refund'>(req: RequestConfig<T>, paymentDetails: PaymentDetailsResponseBody): ConfirmResponseBody;
/**
 ...
 */
export declare function toRefundResponse<T extends 'confirm' | 'refund'>(req: RequestConfig<T>, paymentDetails: PaymentDetailsResponseBody): RefundResponseBody;
/**
