...
exports.refundWithClient = exports.defaultTimeout = void 0;
const format_1 = require("./error/format");
exports.defaultTimeout = 20000;
const refundWithClient = httpClient => ({ transactionId, body, timeout }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!transactionId)
...
exports.refundWithClient = refundWithClient;
