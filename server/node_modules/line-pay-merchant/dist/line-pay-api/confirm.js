...
exports.confirmWithClient = exports.defaultTimeout = void 0;
const format_1 = require("./error/format");
exports.defaultTimeout = 40000;
const confirmWithClient = httpClient => ({ transactionId, body, timeout }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!transactionId)
...
exports.confirmWithClient = confirmWithClient;
