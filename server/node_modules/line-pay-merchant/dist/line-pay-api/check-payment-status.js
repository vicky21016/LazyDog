...
const checkPaymentStatusWithClient = httpClient => (config) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    if (!config.params)
    ...
    const { data } = yield httpClient.get(`/v3/payments/requests/${transactionId}/check`, Object.assign(Object.assign({}, config), { timeout: (_a = config.timeout) !== null && _a !== void 0 ? _a : exports.defaultTimeout }));
    return data;
});
