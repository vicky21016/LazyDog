...
export const useUserCoupon = async (userId, couponId, orderId, orderTable) => {
  ...
  try {
    ...
    if (order.coupon_id) throw new Error("此訂單已使用其他優惠券");
    ...
    console.log("計算折扣: 原價 =", orderTotalPrice, "折扣 =", discountAmount, "最終價格 =", finalAmount);
