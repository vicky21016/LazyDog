        ...
        <div className={`container mt-5`}>
          <div className={`row`}>
            ...
            <div className={`col-md-9`}>
              <form action>
                <div className={`${styles.right} border p-5`}>
                  <h3 className={`mb-4 ${styles.tTitle}`}>師資內容</h3>
                  <div className={`mb-4`}>
                    <div className={`row`}>
                      <div className={`col-md-6`}>
                        <label className={`form-label`}>姓名<span className={styles.must}>*</span></label>
                        <input type="text" className={`form-control ${styles.controls}`} defaultValue="馬克" placeholder />
                      </div>
                      <div className={`col-md-6`}>
                        <label className={`form-label`}>教學類別<span className={styles.must}>*</span></label>
                      ...
                      <div className={`col-md-12 mt-3`}>
                        <label className={`form-label`}>個人介紹<span className={styles.must}>*</span></label>
                      ...
                      <div className={`col-md-12 mt-3`}>
                        <label className={`form-label`}>經歷<span className={styles.must}>*</span></label>
                      ...
                      <div className={`col-md-12 mt-3`}>
                        <label className={`form-label`}>出版<span className={styles.must}>*</span></label>
                  ...
                  <div className={`col-md-12 mt-3`}>
                    <label className={`form-label`}>師資照片
                    ...
                    <div id="imagePreviewContainer" className={`d-flex flex-wrap gap-3 my-2`}>
                      <div className={styles.imageCard}>
                        ...
                        <button type="button" className={`delete-btn ${styles.deletPic}`}>×</button>
                      </div>                  
                    </div>
