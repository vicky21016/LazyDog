                ...
                <div className={`mb-3`}>
                  <div className="row g-4">
                    <div className={`col-md-12`}>
                      ...
                      <input type="text" className={`form-control ${styles.controls}`} defaultValue="一對一寵物美容教學實作" placeholder disabled readOnly />
                    </div>
                    ...
                    <div className={`col-md-6`}>
                      ...
                      <input type="text" className={`form-control ${styles.controls}`} defaultValue="4,200" placeholder disabled readOnly />
                    </div>
                    <div className={`col-md-6`}>
                      <label className={`form-label`}>開課日期<span className={styles.must}>*</span></label>
                      <input type="text" className={`form-control ${styles.controls}`} defaultValue="2025/12/20 20:00:00" placeholder disabled readOnly />
                    </div>
                    <div className={`col-md-6`}>
