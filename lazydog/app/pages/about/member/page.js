        ...
        <div className="container-fluid">
          <div className="row flex-nowrap">
            <div className="col py-3">
              ...
              <h5>一、認知與接受條款</h5>
              <p className="lead">
              「LAZYDOG」(以下簡稱「本公司」)係依據本服務條款提供「LAZYDOG」服務 (以下簡稱「本服務」)。當會員完成本公司之會員註冊手續、或開始使用本服務時，即表示已閱讀、瞭解並同意接受本服務條款之所有內容，並完全接受本服務現有與未來衍生的服務項目及內容。
              </p>
              <p className="lead">
              ...
              <div>
              <h5>二、會員的註冊義務</h5>為了能使用本服務，會員需同意以下事項：
              <p className="lead">
              ...
              <ul>
              <li> 會員的密碼或帳號遭到盜用或有其他任何安全問題發生時，會員將立即通知本公司。</li>
              <li>每次連線完畢，均結束會員的帳號使用。</li>
              <li>會員的帳號、密碼及會員權益均僅供會員個人使用及享有，不得轉借、轉讓他人或與他人合用</li>
              <li>帳號及密碼遭盜用、不當使用或其他本公司無法辯識是否為本人親自使用之情況時，對此所致之損害，除證明係因可歸責於本公司之事由所致，本公司將不負任何責任。</li>
              <li>本公司若知悉會員之帳號密碼確係遭他人冒用時，將立即暫停該帳號之使用(含該帳號所生交易之處理)。</li>
              </ul>
