...
export default async function CustomerPage(props) {
    return (
      <>
        <Header />
        <section className="lumi-all-wrapper my-5">
          <p className="mb-5">
            非常歡迎您光臨「LAZYDOG」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
          </p>
          <div className="mb-5">
            <h4 className="mb-3">一、隱私權保護政策的適用範圍</h4>
            <p>
              隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。
            </p>
          </div>
          <div className="mb-5">
            <h4 className="mb-3">二、個人資料的蒐集、處理及利用方式</h4>
            <p>
          ...
          <div className="mb-5">
            <h4 className="mb-3">四、網站對外的相關連結</h4>
            <p>
              本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
            </p>
          </div>
          <div className="mb-5">
            <h4 className="mb-3">五、與第三人共用個人資料之政策</h4>
            <p>
          ...
          <div className="mb-5">
            <h4 className="mb-3">六、Cookie 之使用</h4>
            <p>
          ...
          <div className="mb-5">
            <h4 className="mb-3">七、隱私權保護政策之修正</h4>
            <p>
              本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。
            </p>
          </div>
          <div className="mb-5">
            <h4 className="mb-3">八、聯繫管道</h4>
            <p>
