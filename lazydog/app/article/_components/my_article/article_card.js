...
export default function MoreCard({ id, title, cover_image, created_at }) {
    ...
    return (
        <>
            <div className={`${styles.articleHisHieght} row my-3`} style={{ backgroundColor: 'white', width: '100%' }}>
                <img className="col-md-4" src={cover_image} alt="" style={{ objectFit: 'cover' }} />
                        ...
                        <div className="col-md-2 d-flex align-items-center">
                            <Dropdown>
                                ...
                                <Dropdown.Menu className={`${styles.customDropdownMenu}`} style={{ width: '25px', backgroundColor: '#FFF6E8' }}>
                                    <Dropdown.Item className={`${styles.item}`} href="#">檢視</Dropdown.Item>
                                    <Dropdown.Item className={`${styles.item}`} href="#">編輯</Dropdown.Item>
