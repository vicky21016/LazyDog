  ...
  return (
    <>
      ...
      <section className="lumi-all-wrapper my-4">
        ...
        <div className="mb-5">
          <h5 className="mb-3">四、網站對外的相關連結</h5>
          <p>
            本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
          </p>
        </div>
        <div className="mb-5">
          <h5 className="mb-3">五、與第三人共用個人資料之政策</h5>
          <p>
        ...
        <div className="mb-5">
          <h5 className="mb-3">六、Cookie 之使用</h5>
          <p>
        ...
        <div className="mb-5">
          <h5 className="mb-3">七、隱私權保護政策之修正</h5>
          <p>
            本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。
          </p>
        </div>
        <div className="mb-5">
          <h5 className="mb-3">八、聯繫管道</h5>
          <p>
